...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ednaapi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ednaapi API";

        private String description = "ednaapi API documentation";
