package net.nomagic.edna.uaa.web.rest;

import net.nomagic.edna.uaa.config.Constants;
import com.codahale.metrics.annotation.Timed;
import net.nomagic.edna.uaa.domain.Authority;
import net.nomagic.edna.uaa.domain.User;
import net.nomagic.edna.uaa.repository.AuthorityRepository;
import net.nomagic.edna.uaa.repository.UserRepository;
import net.nomagic.edna.uaa.security.AuthoritiesConstants;
import net.nomagic.edna.uaa.service.MailService;
import net.nomagic.edna.uaa.service.UserService;
import net.nomagic.edna.uaa.web.rest.dto.ManagedUserDTO;
import net.nomagic.edna.uaa.web.rest.util.HeaderUtil;
import net.nomagic.edna.uaa.web.rest.util.PaginationUtil;
