...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ednagateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ednagateway API";

        private String description = "ednagateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ednagateway";
